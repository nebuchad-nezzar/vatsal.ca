...
export default function CommandBar(props) {
  ...
  const actions = [
    ...
    },
    {
      ...
      keywords: 'send-email',
      section: 'General',
      perform: () => window.open('mailto:vatswork10@gmail.com', '_blank'),
    ...
    // },
    {
      ...
      keywords: 'go-github',
      section: 'Follow',
      perform: () => window.open('https://github.com/nebuchad-nezzar', '_blank'),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://www.linkedin.com/in/vatsal-sharma-672a07137', '_blank'),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://www.instagram.com/vats360/', '_blank'),
