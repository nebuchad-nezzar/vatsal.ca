...
Backtesting is the process of creating the historical trades, given the historical information available at the time, and the finding
out the performance of those trades. <Sidenote number="1">Backtesting is a key component of quantitative trading strategy development.</Sidenote>
