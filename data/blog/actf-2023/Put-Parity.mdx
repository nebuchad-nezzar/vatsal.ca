...
Whichever approach you prefer, it is irrefutable to the fact that the stock prices are determined by supply and demand. For example, when a company is scaling up and wishing to raise capital for fixed investment, stock prices ar the overall equity market levels are likely to change fro day to day becasue the demand is changing constantly rather than the net supply of equity is increasing. So, if the investors are feeling particularly confident, then they may well allocate
...
Empherically, single equity price and the stock market tend to follow a pattern that closely resembles to what math nerds call it as the random walk. The random walk hypothesis is a statistical hypothesis that the price of a stock or a stock market index follows(usually). 
