...
// * Re-write the bio better. Make it professional and witty and interesting.
// ? Fix these.... Just replace the variables with the actual values. this is for below 
// ! Invalid DOM property `stroke-linejoin`. Did you mean `strokeLinejoin`? Change it
//  TODO Add fonr-mono to all the text on this page
...
// Avatar URL Image1: 'https://i.postimg.cc/RVTp2GNP/avatar3.jpg',
// Avatar URL Image2:  'https://i.postimg.cc/sDB1NH6z/avatar2.jpg'
// Avatar URL Image3: 
// Avatar URL Image4:
...
export default function About() {
    return (
      <>
        <div className="space-y-1 py-8 md:space-y-5">
          <h2 className="text-3xl font-extrabold leading-9 tracking-tight text-foreground sm:text-4xl sm:leading-10 md:text-6xl md:leading-14 font-mono">
            About
          </h2>
        </div>
        <div className="divide-y divide-accent-foreground dark:divide-accent"></div>
        <div className="flex items-center justify-between font-mono">
          <div className="flex-1 space-y-1.5">
            <h1 className="md:text-2xl font-bold">{RESUME_DATA.name}</h1>
            <p className="max-w-md text-pretty text-sm text-foreground">
              {RESUME_DATA.about}
            </p>
        ...
        <div className="font-mono">
            <p>
          I'm Vatsal Sharma, a Software Engineer living in Toronto.
          </p>
        </div>
        <br></br>
        <div className="font-mono">
            <p>
          I'm very enjoy to learning about new things and trying out different things in life and in professional space. I truly believe that one should never stop learning. 
        ...
        <div className="font-mono">
            <p>
          My goal is to solve complex real-world problems via big data that are data-driven. I'm passionate about Computer vision, Software Engineering, and Machine Learning techniques. An engineer that has passion for code and designs for fun.
          I work across range of technology including Data Science, Computer Vision and Blockchains. I have experience working from start-ups to conglomerates.
          </p>
        </div>
        
        <br></br>
        <div className="font-mono">
          Besides programming, I'm also into football, tennis and chess. I also do astro/photography in my leisure. Also, I love reading and movies. 
        </div>
        <br></br>
        <div className="font-mono">
            Feel free to reach out if you have anything to talk about, you can reach me on{' '}
              <RoughNotation type="highlight" show={true} color="#FBCFE8" animationDelay={1200}>
                <span className="dark:text-gray-700">  vatswork10@gmail.com </span>
              </RoughNotation>
                          or on  other socials.
        </div>
        <br></br>
...
{/* Add the source of this code */}
        ...
        <div className="space-y-3">
          <dl className="flex flex-col sm:flex-row gap-1">
            <dt className="min-w-40">
              <span className="block text-sm text-gray-500 dark:text-neutral-500">Languages:</span>
            </dt>
            <dd>
              <ul>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
                  <svg className="shrink-0 size-4 me-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <dl className="flex flex-col sm:flex-row gap-1">
            <dt className="min-w-40">
              <span className="font-mono block text-sm text-gray-500 dark:text-neutral-500">Development:</span>
            </dt>
            <dd>
              <ul>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
          ...
          <dl className="flex flex-col sm:flex-row gap-1">
            <dt className="min-w-40">
              <span className="block text-sm text-gray-500 dark:text-neutral-500">Technologies:</span>
            </dt>
            <dd>
              <ul>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
          ...
          <dl className="flex flex-col sm:flex-row gap-1">
            <dt className="min-w-40">
              <span className=" font-mono block text-sm text-gray-500 dark:text-neutral-500">Frameworks:</span>
            </dt>
            <dd>
              <ul>
                <li className="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 dark:text-neutral-200">
  ...
  <ResumeCard
  key={publication.company}
  logoUrl={publication.logoUrl}
  altText={publication.company}
  title={publication.company}
  subtitle={publication.title}
  href={publication.href}
  badges={publication.badges}
  period={`${publication.start}`}
  description={publication.description}

              // key={publication.papertitle}
              // href={publication.href}
              // logoUrl={publication.logoUrl}
              // altText={publication.description}
      ...
      {/* <div class="mt-10 sm:mt-14">
        ...
        <div>
          ...
          <div class="group relative flex gap-x-5">
            ...
            <div class="relative group-last:after:hidden after:absolute after:top-8 after:bottom-2 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-200 dark:after:bg-neutral-700">
              <div class="relative z-10 size-6 flex justify-center items-center">
                <svg class="shrink-0 size-6 text-gray-800 dark:text-neutral-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M12 12h.01" />
